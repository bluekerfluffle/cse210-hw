        ...
        while (menuItem != "6")
        {
            ...
            if (menuItem == "1")
            {
                ...
                if (goalType == "1")
                {
                    ...
                    EasyGoal easy = new EasyGoal(name, description, score, false);
                    goals.Add(easy);
                }
                ...
                else if (goalType == "2")
                {
                    ...
                    EternalGoal eternal = new EternalGoal(name, description, score, 0);
                    goals.Add(eternal);
                }
                ...
                if (File.Exists(fileName))
                {
                    ...
                    foreach (string line in lines[1..])
                    {
                        ...
                        if (sections[0] == "EasyGoal")
                        {
                            ...
                            EasyGoal easy = new EasyGoal(name, description, score, isComplete);
                            goals.Add(easy);
                        }
